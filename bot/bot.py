...
import mcrcon
import configparser
import helmPlayerDb as helmPlayerDb
import helmGuildDb as helmGuildDb
...
rconIp = os.environ['RCON_IP']
rconPassword = os.environ['RCON_PASSWORD']
channelId = os.environ['REG_CHANNEL_ID']
roleId = os.environ['PLAYERS_ROLE_ID']
guildAdmRole = os.environ['GUILD_ADM_ROLE_ID']
